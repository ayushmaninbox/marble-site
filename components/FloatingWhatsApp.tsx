...
export default function FloatingWhatsApp() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener('set-whatsapp-context', handleContextUpdate);
  }, []);
      ...
      {isVisible && (
        <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-3 pointer-events-none">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.9 }}
            className="w-14 h-14 bg-[#25D366] rounded-full shadow-lg shadow-green-200/50 flex items-center justify-center text-white pointer-events-auto relative group active:bg-[#128C7E] transition-colors"
          >
            <svg 
