            ...
            <div className="relative group">
                ...
                {featuredProducts.length > itemsToShow && (
                    <>
                        <button 
                            onClick={handlePrev}
                            className="absolute top-1/2 -left-4 lg:-left-12 -translate-y-1/2 w-10 h-10 bg-white rounded-full shadow-lg border border-stone-100 flex items-center justify-center text-slate-700 hover:text-red-600 hover:border-red-200 transition-all z-20"
                        >
                        ...
                        <button 
                            onClick={handleNext}
                            className="absolute top-1/2 -right-4 lg:-right-12 -translate-y-1/2 w-10 h-10 bg-white rounded-full shadow-lg border border-stone-100 flex items-center justify-center text-slate-700 hover:text-red-600 hover:border-red-200 transition-all z-20"
                        >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
