...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Link href={`/products/${product.id}`}>
      <article className="group flex flex-col overflow-hidden rounded-2xl border border-sky-100 bg-white shadow-[0_18px_45px_rgba(56,189,248,0.18)] transition hover:-translate-y-1 hover:border-sky-300 hover:shadow-[0_28px_70px_rgba(59,130,246,0.3)] cursor-pointer">
        ...
        <div className="flex flex-1 flex-col justify-between p-5">
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <span className="inline-flex items-center justify-center rounded-full border border-sky-200 bg-white/90 px-4 py-2 text-xs font-medium text-slate-900 shadow-sm transition group-hover:border-sky-300 group-hover:bg-gradient-to-r group-hover:from-sky-50 group-hover:to-blue-50">
              View Details
            </span>
          </div>
        </div>
