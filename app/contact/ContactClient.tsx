        ...
        <section className="pb-16 lg:pb-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 gap-3 mb-8 lg:hidden">
              <a href="tel:9830123779" className="flex flex-col items-center justify-center p-4 bg-white border border-slate-100 rounded-2xl shadow-sm hover:border-red-100 transition-colors group">
              ...
              <a href="https://wa.me/919830123779" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center p-4 bg-white border border-slate-100 rounded-2xl shadow-sm hover:border-red-100 transition-colors group">
              ...
              <a href="mailto:shreeradhesr2018@gmail.com" className="flex flex-col items-center justify-center p-4 bg-white border border-slate-100 rounded-2xl shadow-sm hover:border-red-100 transition-colors group">
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-slate-600 text-sm">9830123779</p>
                      <p className="text-slate-400 text-xs mt-1">Daily: 9:00 AM - 12:00 AM</p>
                    </div>
                    <a
                      href="https://wa.me/919830123779"
                      target="_blank"
                      rel="noopener noreferrer"
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-slate-600 text-sm">shreeradhesr2018@gmail.com</p>
